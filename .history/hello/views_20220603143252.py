...
from hello.static.algorithm import Train_batch
from django.templatetags.static import STATIC_ROOT
import os
...
def index(request):
    ...
    if('username' in request.session):
        ...
        return render(request, "home.html",{"isLogin":True})
    else:
        print(static.url)
        Train_batch(20, os.path.dirname(os.path.abspath("my_app"))+os.sep)
